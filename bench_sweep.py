...
def run_point(
    ...
    from verify_seatnow import verify_suite
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--work-dir",
        type=Path,
        default=PROJECT_DIR / "bench" / "sweep",
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=PROJECT_DIR / "bench" / "sweep_report.json",
    )
    parser.add_argument(
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    from verify_seatnow import discover_expectations
